...
export const metricsData: Metric[] = [
  ...
  // MARKET INDICATORS - NEW CATEGORY
  {
    category: 'market',
    name: 'VIX Index',
    description: 'CBOE Volatility Index measuring market fear and uncertainty',
    priority: 'critical',
    frequency: 'daily',
    timing: 'leading',
    source: 'Alpha Vantage/CBOE',
    impact: 'Market stress indicator, risk appetite measure, trading sentiment'
  },
  {
    category: 'market',
    name: 'S&P 500',
    description: 'S&P 500 index level via SPY ETF tracking',
    priority: 'critical',
    frequency: 'daily',
    timing: 'coincident',
    source: 'Alpha Vantage/NYSE',
    impact: 'Broad market performance, economic confidence, wealth effects'
  },
  {
    category: 'market',
    name: 'Dollar Index',
    description: 'U.S. Dollar strength via UUP ETF proxy',
    priority: 'high',
    frequency: 'daily',
    timing: 'leading',
    source: 'Alpha Vantage/NYSE',
    impact: 'Currency strength, international competitiveness, commodity prices'
  },
  {
    category: 'market',
    name: 'Gold Price',
    description: 'Gold price via GLD ETF tracking',
    priority: 'high',
    frequency: 'daily',
    timing: 'leading',
    source: 'Alpha Vantage/NYSE',
    impact: 'Safe haven demand, inflation hedge, monetary policy expectations'
  },
